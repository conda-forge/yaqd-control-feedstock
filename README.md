...
Once the `conda-forge` channel has been enabled, `yaqd-control` can be installed with:

```
conda install yaqd-control
```

It is possible to list all of the versions of `yaqd-control` available on your platform with:
